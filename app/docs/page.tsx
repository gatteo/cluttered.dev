        ...
        <FadeIn>
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-text-secondary max-w-2xl mx-auto">
              Everything you need to know about using Cluttered effectively.
            </p>
          </div>
        </FadeIn>
                  ...
                  <ul className="space-y-2">
                    {sections[sectionName].map((doc) => (
                      <li key={doc.slug}>
                        ...
                        >
                          <div>
                            <span className="text-text-primary group-hover:text-accent-purple transition-colors">
                              {doc.title}
                            </span>
        ...
        <FadeIn delay={0.4}>
          <Card className="mt-12 p-8">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link
                href="/ecosystems"
                className="px-4 py-2 rounded-lg bg-white/10 text-text-secondary hover:text-text-primary transition-colors"
              >
