...
export function Problem() {
  return (
    <Section className="relative">
      <Container>
        <SectionHeader title="Sound Familiar?" description="Every developer knows the pain of running out of disk space" />
          ...
          {problems.map((problem, index) => (
            <FadeIn key={problem.title} delay={index * 0.1}>
              <Card className="h-full">
                ...
                <h3 className="text-xl font-semibold text-text-primary mb-2">{problem.title}</h3>
